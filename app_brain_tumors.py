...
with st.sidebar:
    ...
    """<br><h1 style="color:#115764; font-size:230%"><b>NEUROLOGS</b><br></h1>
    <hr color=#ffcc00>
    <p style="font-size:110%;"><br>Brain disorders are a major public health problem and addressing 
    their enormous social and economic burden is an absolute emergency.<br><br>
    As well as <b>a formidable challenge</b>.<br><br>
    <b>Artificial Intelligence technologies</b> could revolutionize the medicine by providing 
    efficient tools and relevant solutions for innovative therapeutic approaches and improved 
    personalized treatments.</p>""", height=450)

        
title = components.html("""<div><br><h1 style="color:#9CFF8B; font-size:210%; text-align:center"><b>Brain tumors classifier</b></h1></div>""", height=102)

image_app1 = Image.open("C:\\Users\\Dell\\Desktop\\Neurologs_streamlit_app\\photo_app1.jpg")                        
